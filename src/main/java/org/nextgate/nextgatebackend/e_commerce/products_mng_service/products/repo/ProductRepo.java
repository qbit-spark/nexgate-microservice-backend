...
package org.nextgate.nextgatebackend.e_commerce.products_mng_service.products.repo;
...
public interface ProductRepo extends JpaRepository<ProductEntity, UUID>, JpaSpecificationExecutor<ProductEntity> {
    ...
    Optional<ProductEntity> findByProductIdAndIsDeletedFalseAndStatus(UUID productId, ProductStatus status);
